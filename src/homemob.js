// Mobile Navigation Controller for Homepage
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!mobileIcon || !navLinks) {
        console.warn('Mobile navigation elements not found on homepage');
        return;
    }
    ...
    console.log('Homepage mobile navbar controller loaded successfully');
});